(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[5675], {
    ...
    28045: function(e, t, i) {
        ...
        t.default = function(e) {
            var t, i, l = e.src, c = e.sizes, p = e.unoptimized, h = void 0 !== p && p, w = e.priority, k = void 0 !== w && w, I = e.loading, E = e.lazyRoot, _ = e.lazyBoundary, O = e.className, R = e.quality, C = e.width, L = e.height, q = e.style, M = e.objectFit, N = e.objectPosition, P = e.onLoadingComplete, W = e.placeholder, B = void 0 === W ? "empty" : W, Z = e.blurDataURL, D = s(e, ["src", "sizes", "unoptimized", "priority", "loading", "lazyRoot", "lazyBoundary", "className", "quality", "width", "height", "style", "objectFit", "objectPosition", "onLoadingComplete", "placeholder", "blurDataURL"]), U = u.useContext(m.ImageConfigContext), V = u.useMemo(function() {
                var e = v || U || f.imageConfigDefault
            ...
            }, [U]), F = c ? "responsive" : "intrinsic";
            "layout"in D && (D.layout && (F = D.layout),
            delete D.layout);
            var H = j;
            if ("loader"in D) {
                if (D.loader) {
            ...
            if (function(e) {
                ...
                if (Z = Z || J.blurDataURL,
                T = J.src,
                (!F || "fill" !== F) && (L = L || J.height,
                C = C || J.width,
                !J.height || !J.width))
            ...
            var Q = !k && ("lazy" === I || void 0 === I);
            (l.startsWith("data:") || l.startsWith("blob:")) && (h = !0,
            Q = !1),
            b.has(l) && (Q = !1),
            V.unoptimized && (h = !0);
            var K = o(u.useState(!1), 2)
              , X = K[0]
              , Y = K[1]
              , $ = o(g.useIntersection({
            ...
            if ("fill" === F)
                ...
                "responsive" === F ? (eo.display = "block",
                eo.position = "relative",
                ea = !0,
                er.paddingTop = eg) : "intrinsic" === F ? (eo.display = "inline-block",
                eo.position = "relative",
                eo.maxWidth = "100%",
                ea = !0,
                er.maxWidth = "100%",
                t = "data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20version=%271.1%27%20width=%27".concat(el, "%27%20height=%27").concat(ec, "%27/%3e")) : "fixed" === F && (eo.display = "inline-block",
                eo.position = "relative",
                eo.width = el,
                eo.height = ec)
            }
            ...
            var ep = l
              , eh = "imagesizes";
            eh = "imageSizes";
            var ev = (n(i = {}, "imageSrcSet", em.srcSet),
            n(i, eh, em.sizes),
            n(i, "crossOrigin", D.crossOrigin),
            i)
              , eb = u.default.useLayoutEffect
              , ey = u.useRef(P)
              , ew = u.useRef(l);
            ...
            return u.default.createElement(u.default.Fragment, null, u.default.createElement("span", {
                style: eo
            }, ea ? u.default.createElement("span", {
                style: er
                ...
                "aria-hidden": !0,
                src: t
            }) : null) : null, u.default.createElement(x, Object.assign({}, ez))), k ? u.default.createElement(d.default, null, u.default.createElement("link", Object.assign({
        ...
        var v = {
          ...
          , w = new Map([["default", function(e) {
            ...
            var t, i = e.config, n = e.src, o = e.width, r = ["f_auto", "c_limit", "w_" + o, "q_" + (e.quality || "auto")].join(",") + "/";
            return "".concat(i.path).concat(r).concat(h(n))
        }
        ], ["akamai", function(e) {
            var t = e.config
              , i = e.src
        ...
        function S(e) {
            ...
            var u = function(e, t, i, n) {
                ...
                if (n && ("fill" === i || "responsive" === i)) {
                    for (var l = /(^|\s)(1?\d?\d)vw/g, c = []; s = l.exec(n); s)
                        c.push(parseInt(s[2]));
                    if (c.length) {
                        var s, u, d = .01 * (u = Math).min.apply(u, r(c));
                        return {
        ...
        var x = function(e) {
            ...
            return g = d ? "lazy" : g,
            u.default.createElement(u.default.Fragment, null, u.default.createElement("img", Object.assign({}, x, t, {
                decoding: "async",
                "data-nimg": o,
                className: r,
                style: a({}, l, c),
                ref: u.useCallback(function(e) {
                    w(e),
                    (null == e ? void 0 : e.complete) && k(e, m, o, f, b, y)
                }, [w, m, o, f, b, y, ]),
                onLoad: function(e) {
                    k(e.currentTarget, m, o, f, b, y),
                    z && z(e)
                },
                onError: function(e) {
                    "blur" === f && y(!0),
    ...
    57190: function(e, t, i) {
        ...
        t.useIntersection = function(e) {
            var t, i = e.rootRef, s = e.rootMargin, u = e.disabled || !a, d = n(o.useState(!1), 2), f = d[0], g = d[1], m = n(o.useState(null), 2), p = m[0], h = m[1];
...
//# sourceMappingURL=5675-c925d8fac083b8b5.js.map
